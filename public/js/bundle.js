      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            data = response.data;
            (0, _alert.showAlert)('success', 'User logged in succesfully');
            location.assign('/');
            _context.next = 13;
            break;
          ...
          case 9:
            ...
            message = _context.t0.response && _context.t0.response.data && _context.t0.response.data.message || _context.t0.message;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error in logging out, try again!');
...
var updateUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    var endpoint, response, user, _error$response, _error$response$data, message;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return _axios.default.patch(endpoint, data);

          case 5:
            response = _context.sent;
            user = response.data.data.user;
            document.querySelector('#nav__username').textContent = user.name.split(' ')[0];
          ...
          case 11:
            ...
            message = ((_error$response = _context.t0.response) === null || _error$response === void 0 ? void 0 : (_error$response$data = _error$response.data) === null || _error$response$data === void 0 ? void 0 : _error$response$data.message) || _context.t0.message;
            (0, _alert.showAlert)('error', message);
...
var updatedUserForm = document.querySelector('.form-user-data');
...
if (updatedUserForm) {
  ...
  updatedUserForm.addEventListener('submit', function (e) {
    e.preventDefault();
    console.log('what is that');
    var data = new FormData();
    var name = updatedUserForm.name.value;
    var email = updatedUserForm.email.value;
    var photo = updatedUserForm.photo.files[0];
    data.append('name', name);
    data.append('email', email);
    data.append('photo', photo);
    console.log('hey');
    console.log(photo);
    (0, _updateUser.updateUser)(data);
  });
}
},{"./login":"login.js","./updateUser":"updateUser.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
